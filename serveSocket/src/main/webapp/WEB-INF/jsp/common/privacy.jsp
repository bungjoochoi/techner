...
<section class="section">
    <div class="section-sub">
      ...
      <div class="sub-hero-wrap">
        <p class="sub-hero-text"><span class="core-color">개인정보</span> 취급방침<i class="icon icon-law"></i></p>
        <p class="sub-hero-text2">BIZcare는 정보통신망 이용촉진 및 정보보호에 관한 법률을 준수하고 있습니다.</p>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <section class="agree-wrap">
        <div id="privacy" class="privacy">
          <p class="grayBox">`BnE` 은 (이하 `회사`는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다.
          ...
          <br>
          ο 본 방침은 : 2012 년 01 월 01 일 부터 시행됩니다.<br>
          </p>
          <h3> 수집하는 개인정보 항목</h3>
          <p>
            회사는   회원가입, 상담, 서비스 신청 등등을 위해 아래와 같은 개인정보를 수집하고 있습니다.<br>
            <br>
            ο 수집항목 : 이름, 로그인ID, 비밀번호, 휴대전화번호, 이메일, 서비스 이용기록, 접속 로그, 쿠키, 접속 IP 정보<br>
            ο 개인정보 수집방법 : 홈페이지(회원가입,고객문의 등) <br>
          </p>
          ...
          <p>
            이용자 및 법정 대리인은 언제든지 등록되어 있는 자신 혹은 당해 만 14세 미만 아동의 개인정보를 조회하거나 수정할 수 있으며 가입해지를 요청할 수도 있습니다.<br> 이용자 혹은 만 14세 미만 아동의 개인정보 조회?수정을 위해서는 ‘개인정보변경’(또는 ‘회원정보수정’ 등)을 가입해지(동의철회)를 위해서는 “회원탈퇴”를 클릭하여 본인 확인 절차를 거치신 후 직접 열람, 정정 또는 탈퇴가 가능합니다. 혹은 개인정보관리책임자에게 서면, 전화 또는 이메일로 연락하시면 지체없이 조치하겠습니다. <br>
            ...
            BnE는 이용자 혹은 법정 대리인의 요청에 의해 해지 또는 삭제된 개인정보는 “BnE가 수집하는 개인정보의 보유 및 이용기간”에 명시된 바에 따라 처리하고 그 외의 용도로 열람 또는 이용할 수 없도록 처리하고 있습니다.<br>
          </p>
          ...
          <p>
            ...
            - 고객서비스담당 부서 : BnE<br>
            - 전화번호 : 02-2084-6700<br>
            - 이메일 :   bnehr@thebne.com<br><br>
