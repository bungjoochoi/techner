...
<title>Agree</title>
	...
	<script >
		...
		$(document).ready(function(){
		    $("#redirect-main").click(function() {
		    	location.href = "<c:url value="/main"/>";
		    });  
		    $("#redirect-csr").click(function() {
		    	location.href = "<c:url value="/main"/>";
		    });  
		});
...
<section class="section">
    <div class="section-sub">
      ...
      <div class="sub-hero-wrap">
        <p class="sub-hero-text"><span class="core-color">이용</span> 약관<i class="icon icon-law"></i></p>
    ...
    <div class="container">
        <section class="agree-wrap">
          <section id="additional">
            ...
            이 약관은 전기통신 사업법 및 동 법 시행령에 의하여 BnE(이하 "회사" 라 합니다.)가 제공하는 인터넷 홈페이지 서비스 (이하 "서비스" 라 합니다.)의 이용조건 및 절차에 관한 사항, 회사와 이용자의 권리와 의무 및 책임사항을 규정함을 목적으로 합니다.<br>
            <br>
            <br>
            <strong>제 2조 (약관의 효력과 개정)</strong> <br>
            <br>
            ...
            <br>
            <br>
            <strong>제 5조 (서비스의 제공 및 변경)</strong> <br>
            <br>
            ...
            <br>
            <br>
            <strong>제 8조 (회원탈퇴 및 자격 상실 등) </strong><br>
            <br>
            ...
            <br>
            <br>
            <strong>제 9조 (이용자에 대한 통지) </strong><br>
            <br>
            ...
            <br>
            <br>
            <strong>제 10조 (개인 정보 보호) </strong><br>
            <br>
            ...
            <br>
            <br>
            <strong>제 12조 (회원의 ID 및 비밀번호에 대한 의무) </strong><br>
            <br>
            ...
            <br>
            <br>
            <strong>제 15조 (게시물에 대한 권리 / 의무) </strong><br>
            <br>
            게시물에 대한 저작권을 포함한 모든 권리 및 책임은 이를 게시한 이용자에게 있습니다.<br>
            <br>
            <br>
            <strong>제 16조 (연결 "홈페이지"와 피연결 "홈페이지"간의 관계)</strong> <br>
            <br>
            ...
            <br>
            <br>
            <strong>제 17조 (저작권의 귀속 및 이용제한) </strong><br>
            <br>
            ...
            <br>
            <br>
            <strong>제 22조 (기타) </strong><br>
            <br>
            이 약관에 명시되지 아니한 사항의 처리를 위하여 이용자는 BnE.(전화번호 : 02-2084-6700)를 이용합니다.<br>
            <br>
            <br>
            <strong>부칙</strong><br>
            <br>
            이 약관은 2012년 01월 01일부터 시행합니다.
            </div>
              </section>
        </section>

        <div class="detail-btn-wrap">
            <button type="button" class="btn btn-normal" id="redirect-main" >메인으로</button>
            <button type="button" class="btn btn-type1" id="redirect-csr">CSR 요청</button>
        </div>
